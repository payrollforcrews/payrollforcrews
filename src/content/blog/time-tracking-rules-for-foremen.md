...
description: >-
  A short set of rules you can hand to foremen so hours from the field come in
...
Pick one main system, like [TimeCamp](/go/timecamp) or [Connecteam](/go/connecteam), and make it the default for everyone.
...
1. Put them in writing on a single page.
2. Review them with your foremen in a short meeting.
3. Make your time tracking app match the rules as much as possible:
