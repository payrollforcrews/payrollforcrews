...
**Fix:** Centralize your overtime tracking. Keep job and location info tied to each time entry. This is where a tool like [TimeCamp](/go/timecamp) can help by linking time tracking to jobs and payroll, so you do not have to do the math manually.

If you are regularly crossing state lines with your crews, our guide on [running construction payroll across multiple states](https://payrollforcrews.com/blog/multi-state-construction-payroll/) walks through how to set up workweeks, locations, and records so you do not get burned.
...
If you are unsure how to define your workweek or how overtime fits into your payroll setup, our guide to the [best payroll and time tracking setup for 10 to 50 person construction crews](https://payrollforcrews.com/blog/construction-payroll-setup/) walks through practical options.
...
If you also use independent contractors alongside W2 employees, read our guide on [handling payroll when you have both W2 employees and 1099 contractors](https://payrollforcrews.com/blog/w2-and-1099-payroll/) so you do not accidentally dodge overtime rules by misclassifying people.
...
If you are still on paper time sheets, our 30 day plan for [getting off paper timesheets with small construction crews](https://payrollforcrews.com/blog/switching-from-paper-timesheets/) walks through a simple rollout that does not blow up your jobs.
